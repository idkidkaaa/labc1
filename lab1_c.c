...
int test_sin() {
	...
	r = r || (abs_v(abs_v(sin_acc(-1 * PI/2)) - 1 >= E));
	r = r || (abs_v(abs_v(sin_acc(-1 * PI)) - 0 >= E));
	r = r || (abs_v(abs_v(sin_acc(-1 * 3 * PI/2)) - 1 >= E));
	r = r || (abs_v(abs_v(sin_acc(- 2 * PI)) - 0 >= E));
	r = r || (abs_v(abs_v(sin_acc(PI/6)) - 0.5 >= E));
	r = r || (abs_v(abs_v(sin_acc(7 * PI/6)) - 0.5 >= E));
